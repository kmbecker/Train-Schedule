var url ="https://train-scheduler-kucoding.firebaseio.com";
...
$(document).ready(function() {
     ...
     $("#add-train").on("click", function() {
     	...
     	keyHolder = dataRef.push({
          ...
          // The notes below are for finding the path to the key in the data being pushed, 
          // leaving as notes to save for later use.
